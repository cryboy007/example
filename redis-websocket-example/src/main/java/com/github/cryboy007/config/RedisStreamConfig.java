...
import com.github.cryboy007.stream.AsyncConsumeStreamListener;
import com.github.cryboy007.stream.CustomErrorHandler;
...
public class RedisStreamConfig {
    ...
    public StreamMessageListenerContainer<String, ObjectRecord<String, Book>> streamMessageListenerContainer() {
        ...
        // 独立消费
        String streamKey = RedisConstant.STREAM_KEY_001;
